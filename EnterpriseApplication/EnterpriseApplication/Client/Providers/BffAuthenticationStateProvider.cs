...
namespace EnterpriseApplication.Client.Providers
{
    public partial class BffAuthenticationStateProvider : AuthenticationStateProvider
    {
        ...
        private async Task<ClaimsPrincipal> FetchUser()
        {
            try
            {
                ...
                {
                    var claims = await response.Content.ReadFromJsonAsync<List<ClaimRecord>>() ?? new List<ClaimRecord>();
